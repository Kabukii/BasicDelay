...
//==============================================================================
BasicDelayAudioProcessorEditor::BasicDelayAudioProcessorEditor (StereoPannerAudioProcessor& p)
    : AudioProcessorEditor(p), processor(p)
{
    ...
    sliderDelayTime->setSliderStyle (Slider::Rotary);
    sliderDelayTime->setTextBoxStyle (Slider::TextBoxBelow, false, 80, 20);
    sliderDelayTime->addListener (this);

    addAndMakeVisible (sliderFeedback = new Slider ("feedback"));
    sliderFeedback->setRange (0, 0.95, 0);
    sliderFeedback->setSliderStyle (Slider::Rotary);
    sliderFeedback->setTextBoxStyle (Slider::TextBoxBelow, false, 80, 20);
...
void BasicDelayAudioProcessorEditor::resized()
{
    ...
    sliderDelayTime->setBounds (112, 152, 160, 64);
    sliderFeedback->setBounds (120, 304, 144, 72);
    labelDelayTime->setBounds (120, 128, 150, 24);
    labelFeedback->setBounds (128, 280, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="BasicDelayAudioProcessorEditor"
  ...
  <SLIDER name="delay time" id="18a5eb1b7a727323" memberName="sliderDelayTime"
          virtualName="" explicitFocusOrder="0" pos="112 152 160 64" min="0.010000000000000000208"
          max="1" int="0" style="Rotary" textBoxPos="TextBoxBelow" textBoxEditable="1"
          textBoxWidth="80" textBoxHeight="20" skewFactor="1" needsCallback="1"/>
  <SLIDER name="feedback" id="5dd697371f9545d3" memberName="sliderFeedback"
          virtualName="" explicitFocusOrder="0" pos="120 304 144 72" min="0"
          max="0.94999999999999995559" int="0" style="Rotary" textBoxPos="TextBoxBelow"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
  <LABEL name="new label" id="3012641a5773b195" memberName="labelDelayTime"
         virtualName="" explicitFocusOrder="0" pos="120 128 150 24" edTextCol="ff000000"
         edBkgCol="0" labelText="Delay Time (seconds)" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" bold="0" italic="0" justification="33"/>
  <LABEL name="new label" id="d3aca27d3ef4838f" memberName="labelFeedback"
         virtualName="" explicitFocusOrder="0" pos="128 280 150 24" edTextCol="ff000000"
